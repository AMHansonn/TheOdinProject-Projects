...
This is my take on the Recipes project assignment in [the Odin Project](https://www.theodinproject.com/dashboard).

---

## **Assignment** *(requirements pulled from the Odin website.)*
...
5. Add a link back to the index page on your recipe page for easier navigation. You can place this link at the top or bottom of your recipe page (e.g., `lasagna.html`). Here’s an example: ```<a href="../index.html">Home</a>``` <br>
...
2. Don't forget to link the new recipes on the index page. Also, consider putting all the links in an unordered list so they aren't all on one line. ✅
    * *note: one may also use `<br>` so they aren't all on one line.*
---
<!-- ## Notes -->